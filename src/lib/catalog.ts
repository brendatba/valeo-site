...
export interface Fragrance { id: string; name: string; mood: string; tint: string; swatch?: string; note: string; tag?: string; hero?: string; heroVideo?: string; heroM?: string; heroP?: string; heroPBg?: string; heroVideoP?: string; thumb?: string }
...
export interface Catalog {
  ...
  /** Fragrance ids shown in the home page's pinned passage, in order; the last one is the peak. */
  passage?: string[];
