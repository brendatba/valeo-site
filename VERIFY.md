# VERIFY.md — rubric run 2026-09-11 (v3, after the design rebuild)
...
| R8 | Performance / a11y | **2** | Lighthouse mobile (median of 3): home perf 93 / a11y 100 · shop 100 / 100 · checkout 100 / 100, with four lazy scroll-triggered videos wired. Every `<img>` has alt (asserted in `tests/home.spec.ts`). Reports: `screens/lighthouse/*.html` |
