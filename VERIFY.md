# VERIFY.md — rubric run 2026-09-11 (final)
...
| R8 | Performance / a11y | **2** | Lighthouse mobile (median of 3): home perf 92 / a11y 100 · shop 99 / 100 · checkout 100 / 100. Every `<img>` has alt (asserted in `tests/home.spec.ts`). Reports: `screens/lighthouse/*.html` |
...
Playwright: 21/21 passed (mobile + desktop projects). TypeScript: 0 errors.
