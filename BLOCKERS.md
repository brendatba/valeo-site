...
| 10 | 13 scents have no imagery; coffee's world is shot on a dark ground | World panel carries them with typography (name at 3rem + note), no placeholder. Coffee keeps its still, no video. | `MEDIA-RULING.md` §1d, §3 | fal top-up + Brenda's yes on the $50 tier |
